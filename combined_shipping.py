...
def _xml_set_shipping_discount_profiles(token: str, rule: dict,
    ...
    return (
        ...
        f'  <CombinedDuration>Days_14</CombinedDuration>\n'
        f'  <CombinedPaymentOption>CombinedPaymentOK</CombinedPaymentOption>\n'
...
"""
    ...
    extra_css = (
        ...
        ".stat-n{font-family:'Fraunces',Georgia,serif;font-style:italic;font-weight:500;font-variation-settings:'opsz' 144,'SOFT' 30,'WONK' 1;letter-spacing:-0.005em;font-size:32px;color:var(--gold);line-height:1}"
