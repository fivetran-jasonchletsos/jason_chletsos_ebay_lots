...
CARDS = [
 ...
 ("Johnson","Randy Johnson","Diamondbacks · Panini Crusade jersey-numeral insert (copy 1)",1,2,4,"confirm 2 real copies vs copy 2 — may be same design"),
 ("Johnson","Randy Johnson","Diamondbacks · Panini Crusade jersey-numeral insert (copy 2)",1,2,4,"confirm 2 real copies vs copy 1 — may be same design"),
