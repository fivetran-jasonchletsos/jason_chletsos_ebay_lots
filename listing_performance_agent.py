...
CSS = (
    "body{font-family:'Familjen Grotesk',-apple-system,BlinkMacSystemFont,sans-serif;background:#0a0a0a;color:#eaeaea;margin:0;padding:24px;}"
    "h1{font-family:'Fraunces',Georgia,serif;font-style:italic;font-weight:500;font-variation-settings:'opsz' 144,'SOFT' 30,'WONK' 1;font-size:42px;letter-spacing:-0.005em;margin:0 0 4px;color:#d4af37;}"
    "h2{font-family:'Fraunces',Georgia,serif;font-style:italic;font-weight:500;font-variation-settings:'opsz' 144,'SOFT' 30,'WONK' 1;font-size:26px;letter-spacing:-0.005em;margin:32px 0 12px;color:#d4af37;border-bottom:1px solid #222;padding-bottom:6px;}"
    ...
    ".kpi .value{font-family:'Fraunces',Georgia,serif;font-style:italic;font-weight:500;font-variation-settings:'opsz' 144,'SOFT' 30,'WONK' 1;font-size:30px;color:#fff;margin-top:4px;}"
