"""_class_icons_lots.py — 2025 Topps Signature Class "Class Icons" insert lots.
Built from Scans 201-202.

  python3 _class_icons_lots.py --pdf
  python3 _class_icons_lots.py --apply [--only key1,key2]
"""
...
SET_LABEL = "2025 Topps Signature Class - Class Icons"
...
LOTS = [
    {"key": "ci_stars", "price": 16.99,
     "title": "2025 Topps Signature Class Icons Lot Purdy Garrett Parsons Burns Hutchinson Football",
     "theme": "Stars / Icons Lot",
     "cards": [(202, 1, "Brock Purdy", "49ers", False),
               (202, 2, "Myles Garrett", "Browns", False),
               (202, 3, "Micah Parsons", "Cowboys", False),
               (202, 4, "Brian Burns", "Panthers", False),
               (201, 9, "Aidan Hutchinson", "Lions", False)]},
    {"key": "ci_rook", "price": 14.99,
     "title": "2025 Topps Signature Class Icons RC Lot Cam Ward Walker Johnson Schwesinger Collins",
     "theme": "Rookie / Star Lot",
     "cards": [(201, 3, "Cam Ward", "Titans", True),
               (201, 1, "Jalon Walker", "Falcons", True),
               (201, 7, "Will Johnson", "Cardinals", True),
               (202, 6, "Carson Schwesinger", "Browns", True),
               (201, 5, "Nico Collins", "Texans", False)]},
    {"key": "ci_mix", "price": 13.99,
     "title": "2025 Topps Signature Class Icons Lot Parsons Collins Mailata Sewell Schwesinger",
     "theme": "Trenches / Mixed Lot",
     "cards": [(202, 5, "Micah Parsons", "Cowboys", False),
               (201, 6, "Nico Collins", "Texans", False),
               (201, 4, "Carson Schwesinger", "Browns", True),
               (201, 2, "Jordan Mailata", "Eagles", False),
               (201, 8, "Penei Sewell", "Lions", False)]},
]
...
def do_apply(only=None):
    ...
    for lot in lots:
        ...
        desc = (
            ...
            f"<ul>{items}</ul>"
            "<ul>"
            "<li>2025 Topps Signature Class - Class Icons insert of each card.</li>"
        ...
        specifics = {"Sport": "Football", "Set": "2025 Topps Signature Class",
                     "Insert Set": "Class Icons", "Type": "Sports Trading Card Lot",
...
def main():
    ...
    a = ap.parse_args()
    if a.pdf:
        out = Path("output/signature_class_icons_lots_pull_sheet.pdf")
        build_pdf(out)
        print(f"PDF: {out}")
    if a.apply:
