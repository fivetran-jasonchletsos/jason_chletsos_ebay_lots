"""_class_action_lots.py — 2025 Topps Signature Class "Class Action" insert lots.
Built from Scans 187-188.

  python3 _class_action_lots.py --pdf
  python3 _class_action_lots.py --apply [--only key1,key2]
"""
...
SET_LABEL = "2025 Topps Signature Class - Class Action"
...
LOTS = [
    {"key": "ca_qb", "price": 16.99,
     "title": "2025 Topps Signature Class Action QB Lot Josh Allen Daniels Williams Love Football",
     "theme": "Quarterback Lot",
     "cards": [(188, 1, "Josh Allen", "Bills", False),
               (188, 3, "Jayden Daniels", "Commanders", False),
               (187, 6, "Caleb Williams", "Bears", False),
               (187, 9, "Jordan Love", "Packers", False),
               (188, 2, "Dillon Gabriel", "Browns", True)]},
    {"key": "ca_rb", "price": 15.99,
     "title": "2025 Topps Signature Class Action RB Lot Achane Harvey Hampton Brown Pickens Football",
     "theme": "Running Back / Skill Lot",
     "cards": [(187, 1, "De'Von Achane", "Dolphins", False),
               (187, 2, "RJ Harvey", "Broncos", True),
               (187, 4, "Chase Brown", "Bengals", False),
               (187, 5, "Omarion Hampton", "Chargers", True),
               (187, 8, "George Pickens", "Cowboys", False)]},
    {"key": "ca_mix", "price": 14.99,
     "title": "2025 Topps Signature Class Action Lot Allen Achane Harvey Hampton McMillan Football",
     "theme": "Stars & Rookies Lot",
     "cards": [(188, 4, "Josh Allen", "Bills", False),
               (188, 6, "De'Von Achane", "Dolphins", False),
               (187, 3, "RJ Harvey", "Broncos", True),
               (187, 7, "Omarion Hampton", "Chargers", True),
               (188, 5, "Tetairoa McMillan", "Panthers", True)]},
]
...
def do_apply(only=None):
    ...
    for lot in lots:
        ...
        desc = (
            ...
            f"<ul>{items}</ul>"
            "<ul>"
            "<li>2025 Topps Signature Class - Class Action insert of each card.</li>"
        ...
        specifics = {"Sport": "Football", "Set": "2025 Topps Signature Class",
                     "Insert Set": "Class Action", "Type": "Sports Trading Card Lot",
...
def main():
    ...
    a = ap.parse_args()
    if a.pdf:
        out = Path("output/signature_class_action_lots_pull_sheet.pdf")
        build_pdf(out)
        print(f"PDF: {out}")
    if a.apply:
