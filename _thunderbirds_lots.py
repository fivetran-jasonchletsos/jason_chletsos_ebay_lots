"""_thunderbirds_lots.py — 2025 Panini Phoenix Thunderbirds insert lots.
Built from Scans 183-185.

  python3 _thunderbirds_lots.py --pdf
  python3 _thunderbirds_lots.py --apply [--only key1,key2]
"""
...
SET_LABEL = "2025 Panini Phoenix Thunderbirds"
...
LOTS = [
    {"key": "tb_skill", "price": 16.99,
     "title": "2025 Panini Phoenix Thunderbirds McCaffrey Bijan Henry Adams Metcalf Football",
     "theme": "Star Skill Lot (RB/WR)",
     "cards": [(184, 2, "Christian McCaffrey", "49ers", False),
               (183, 1, "Bijan Robinson", "Falcons", False),
               (183, 7, "Derrick Henry", "Ravens", False),
               (183, 3, "Davante Adams", "Rams", False),
               (183, 2, "DK Metcalf", "Steelers", False)]},
    {"key": "tb_qb", "price": 13.99,
     "title": "2025 Panini Phoenix Thunderbirds QB Mayfield Darnold Nix Smith Fields Football",
     "theme": "Quarterback Lot",
     "cards": [(183, 5, "Baker Mayfield", "Buccaneers", False),
               (183, 6, "Sam Darnold", "Seahawks", False),
               (183, 8, "Bo Nix", "Broncos", False),
               (184, 5, "Geno Smith", "Raiders", False),
               (184, 1, "Justin Fields", "Jets", False)]},
    {"key": "tb_young", "price": 13.99,
     "title": "2025 Panini Phoenix Thunderbirds Young Penix Shough Harrison RC Football",
     "theme": "Young Guns + Rookie Lot",
     "cards": [(184, 4, "Bryce Young", "Panthers", False),
               (184, 6, "Michael Penix Jr", "Falcons", False),
               (184, 7, "Tyler Shough", "Saints", True),
               (183, 4, "Omarion Hampton", "Chargers", True),
               (184, 8, "Marvin Harrison Jr", "Cardinals", False)]},
]
...
def do_apply(only=None):
    ...
    for lot in lots:
        ...
        desc = (
            ...
            f"<ul>{items}</ul>"
            "<ul>"
            "<li>2025 Panini Phoenix - Thunderbirds insert of each card.</li>"
        ...
        specifics = {"Sport": "Football", "Set": "2025 Panini Phoenix",
                     "Insert Set": "Thunderbirds", "Type": "Sports Trading Card Lot",
...
def main():
    ...
    a = ap.parse_args()
    if a.pdf:
        out = Path("output/phoenix_thunderbirds_lots_pull_sheet.pdf")
        build_pdf(out)
        print(f"PDF: {out}")
    if a.apply:
