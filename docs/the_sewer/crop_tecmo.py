"""Slice Tecmo Bowl: Bo Jackson Battle Arena binder-page photos into individual cards.

Same gap-detection approach as crop_scans.py, tuned for these particular
phone photos (2430x3298, cards on white background, sometimes fewer than 9
per page -- e.g. tscan1 only has 7, so its two empty grid slots are deleted
after cropping).
"""
...
SCANS = {
    "tscan1": "Scan 390.jpeg",
    "tscan2": "Scan 388.jpeg",
    "tscan3": "Scan 389.jpeg",
    "tscan4": "Scan 387.jpeg",
    "tscan5": "Scan 386.jpeg",
    "tscan6": "Scan 385.jpeg",
}

SRC_DIR = "/Users/jason.chletsos/Downloads"
OUT_DIR = "/Users/jason.chletsos/Documents/GitHub/jason_chletsos_ebay_lots/docs/the_sewer/tecmo_images"
THUMB_W = 500
